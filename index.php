      ...
      <nav>
          ...
          <div class="flex-item">
            ...
            <form id="ricerca">
              <div class="flex-item">
                ...
                <input type="text" id="search-bar" data-text="Cosa vuoi ascoltare?" autocomplete="off"> 
              </div>
        ...
        <div id="nav-right">
          ...
          <div id="link-right-sep">
            ...
            <div class="flex-item">
                <img src="icons8-download-32-grey.png">
                <a class="item-link"> Installa app</a>
              
            </div>
      
            <a id="iscriviti" href='registrazione.php'> Iscriviti </a>  
            <a href="login.php" id="accedi"> Accedi </a>
